...
public interface QueryConstants {
    ...
    String OPPORTUNITIES_QUERY = "SELECT+Id,Name,AccountId,CloseDate,StageName,Amount,TH_Opportunity_Type__c,TH_Customer_Type__c,TH_Region__c,THCH_Zone__c,THCH_Territory__c," +
            ...
            "TH_Closing_Summary__c,THCMG_Date_Ordered__c,THCMG_Bill_To_Location__c,THCMG_Ship_To_Location__c,THCMG_Bill_To_Location__r.THCMG_Country__c,THCMG_Bill_To_Location__r.THCMG_State__c,THCMG_Bill_To_Location__r.THCMG_City__c," +
    ...
    String ORDERS_QUERY = "SELECT Id,orderNumber,THCMG_Customer_PO__c,AccountId,THCMG_Payment_Term__c,THCMG_ERP_Operating_Unit__c,THCMG_Cheque_Number__c,THCMG_Transaction_Type_Id__c," +
            "THCMG_Bill_To_Location__c,THCMG_Warehouse__c,THCMG_Ship_To_Location__c,THCMG_Date_Ordered__c,THCMG_Payment_Type__c,THCMG_Request_Date__c,EffectiveDate,TotalAmount,THCMG_FOB__c,TH_Division__c," +
            "THCMG_Freight_Terms__c,Status,OpportunityId,ERP_Order_Number__c,TH_Opportunity_Number__c,Asset__c,ERP_Credit_Rating__c,ERP_invoice__c,ERP_Invoiced_value__c,ERP_order_booked_date__c,ERP_Order_Value__c," +
            "ERP_Order_status__c,OwnerId,Owner.Name,(SELECT+Id,Product2Id,TH_Product_Code__c,Listprice,unitprice,totalprice,THCMG_ERP_User_Id__c,TH_Asset__c+from+OrderItems) from Order where Opportunity.recordType.Name = 'Spare+%26+Services'+and+LastmodifiedDate+=";

//    String ORDERS_QUERY = "SELECT Id,orderNumber,THCMG_Customer_PO__c,AccountId,THCMG_Payment_Term__c,THCMG_ERP_Operating_Unit__c,THCMG_Cheque_Number__c,THCMG_Transaction_Type_Id__c," +
//            "THCMG_Bill_To_Location__c,THCMG_Warehouse__c,THCMG_Ship_To_Location__c,THCMG_Date_Ordered__c,THCMG_Payment_Type__c,THCMG_Request_Date__c,EffectiveDate,TotalAmount,THCMG_FOB__c,TH_Division__c," +
//            "THCMG_Freight_Terms__c,Status,OpportunityId,ERP_Order_Number__c,TH_Opportunity_Number__c,Asset__c,ERP_Credit_Rating__c,ERP_invoice__c,ERP_Invoiced_value__c,ERP_order_booked_date__c,ERP_Order_Value__c," +
//            "ERP_Order_status__c,OwnerId,Owner.Name,Opportunity.OwnerId,Opportunity.Owner.Name,Opportunity.Owner.Email,Opportunity.Owner.MobilePhone,Opportunity.Owner.UserRole.Name,Opportunity.TH_Opportunity_Type__c from Order where Opportunity.recordType.Name = 'Spare & Services'";
